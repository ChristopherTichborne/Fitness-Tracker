...
initButtons (void)
{
    ...
    //SWITCH (active HIGH)
    SysCtlPeripheralEnable (SW1_SW_PERIPH);
        GPIOPinTypeGPIOInput (SW1_SW_PORT_BASE, SW1_SW_PIN);
        GPIOPadConfigSet (SW1_SW_PORT_BASE, SW1_SW_PIN, GPIO_STRENGTH_2MA,
           GPIO_PIN_TYPE_STD_WPD);
        but_normal[SLIDE] = SW1_SW_NORMAL;
...
updateButtons (void)
{
    ...
    but_value[SLIDE] = (GPIOPinRead (SW1_SW_PORT_BASE, SW1_SW_PIN) == SW1_SW_PIN);
