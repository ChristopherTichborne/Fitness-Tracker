...
// Constants
//*****************************************************************************
enum butNames {UP = 0, DOWN, LEFT, RIGHT, SLIDE, NUM_BUTS};
...
// SLIDER SWITCH 1
#define SW1_SW_PERIPH SYSCTL_PERIPH_GPIOA
#define SW1_SW_PORT_BASE  GPIO_PORTA_BASE
#define SW1_SW_PIN  GPIO_PIN_7
#define SW1_SW_NORMAL  false
