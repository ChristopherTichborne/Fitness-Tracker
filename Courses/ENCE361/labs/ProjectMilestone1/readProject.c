...
vector3_t convert_to_ms (void)
{
    ...
    ms_accel.x = (981 * ms_accel.x) / 256;
    ms_accel.y = (981 * ms_accel.y) / 256;
    ms_accel.z = (981 * ms_accel.z) /256;
    return ms_accel;
}
...
vector3_t convert_to_g (void)
{
    vector3_t g_accel;
    g_accel = getAcclData();
    g_accel.x = (981 * g_accel.x) / 100;
    g_accel.y = (981 * g_accel.y) / 100;
    g_accel.z = (981 * g_accel.z) / 100;
    return g_accel;
}
...
/*void initOrientation (void)
{
    ...
    //display_value.x = numbers.x - ref_x;
    //display_value.y = numbers.y - ref_y;
    //display_value.z = numbers.z - ref_z;
}
*/
